...
using SV22T1020214.Admin;
using SV22T1020214.BusinessLayers;
using SV22T1020214.Models.Partner;

namespace SV22T1020214.Admin.Controllers
{
    ...
    public class CustomerController : Controller
    {
        ...
        {
            var input = ApplicationContext.GetSessionData<SV22T1020214.Models.Common.PaginationSearchInput>(CUSTOMER_SEARCH_CONDITION);
            if (input == null)
            {
                input = new SV22T1020214.Models.Common.PaginationSearchInput()
                {
                    Page = 1,
                    PageSize = PAGE_SIZE,
                    SearchValue = ""
        ...
        {
            var input = new SV22T1020214.Models.Common.PaginationSearchInput()
            {
                Page = page,
                PageSize = PAGE_SIZE,
            ...
            var data = await SV22T1020214.BusinessLayers.PartnerDataService.ListCustomersAsync(input);
