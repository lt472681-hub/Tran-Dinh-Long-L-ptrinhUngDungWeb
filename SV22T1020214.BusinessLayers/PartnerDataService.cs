...
using SV22T1020214.DataLayers.SqlServer;
using SV22T1020214.Models.Common;
using SV22T1020214.Models.Partner;

namespace SV22T1020214.BusinessLayers
{
    /// <summary>
    ...
    public static class PartnerDataService
    {
        ...
        /// <summary>
        /// Đăng nhập: so khớp mật khẩu đã băm MD5. Nếu không khớp, thử mật khẩu lưu dạng plain (dữ liệu cũ).
        /// </summary>
